...
class WebhookProvider {
    ...
    async callApi(prompt) {
        ...
        logger_1.default.debug(`Calling Webhook: ${this.webhookUrl} with params: ${JSON.stringify(params)}`);
        let response;
        try {
        ...
        logger_1.default.debug(`\tWebhook response: ${JSON.stringify(response.data)}`);
