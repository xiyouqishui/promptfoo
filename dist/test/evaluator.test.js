        ...
        const mockEval = {
            ...
            toEvaluateSummary: jest.fn().mockResolvedValue({
                ...
                stats: {
                    ...
                    failures: 0,
                    errors: 1,
                    tokenUsage: (0, evaluator_1.newTokenUsage)(),
                },
            }),
...
describe('runEval', () => {
    ...
    it('should handle provider errors', async () => {
        ...
        expect(result.failureReason).toBe(types_1.ResultFailureReason.ERROR);
    });
...
describe('calculateThreadsPerBar', () => {
    it('should evenly distribute threads when concurrency is a multiple of numProgressBars', () => {
        ...
        expect((0, evaluator_1.calculateThreadsPerBar)(10, 5, 0)).toBe(2);
        expect((0, evaluator_1.calculateThreadsPerBar)(10, 5, 1)).toBe(2);
        expect((0, evaluator_1.calculateThreadsPerBar)(10, 5, 4)).toBe(2);
        // 12 threads, 6 progress bars = 2 threads per bar
        expect((0, evaluator_1.calculateThreadsPerBar)(12, 6, 0)).toBe(2);
        expect((0, evaluator_1.calculateThreadsPerBar)(12, 6, 5)).toBe(2);
    });
    it('should correctly distribute extra threads for the first N bars', () => {
        ...
        expect((0, evaluator_1.calculateThreadsPerBar)(11, 5, 0)).toBe(3); // First bar gets 2+1
        expect((0, evaluator_1.calculateThreadsPerBar)(11, 5, 1)).toBe(2);
        expect((0, evaluator_1.calculateThreadsPerBar)(11, 5, 4)).toBe(2);
        // 17 threads, 6 progress bars = 2 threads for first 5 bars, 2 for the last
        // floor(17/6) = 2 with 5 extra threads
        expect((0, evaluator_1.calculateThreadsPerBar)(17, 6, 0)).toBe(3); // First bar gets 2+1
        expect((0, evaluator_1.calculateThreadsPerBar)(17, 6, 4)).toBe(3); // Fifth bar gets 2+1
        expect((0, evaluator_1.calculateThreadsPerBar)(17, 6, 5)).toBe(2); // Last bar gets just 2
    });
    it('should handle edge cases', () => {
        // 1 thread, 1 progress bar
        expect((0, evaluator_1.calculateThreadsPerBar)(1, 1, 0)).toBe(1);
        // More progress bars than threads (1 thread per bar until we run out)
        expect((0, evaluator_1.calculateThreadsPerBar)(3, 5, 0)).toBe(1);
        expect((0, evaluator_1.calculateThreadsPerBar)(3, 5, 1)).toBe(1);
        expect((0, evaluator_1.calculateThreadsPerBar)(3, 5, 2)).toBe(1);
        expect((0, evaluator_1.calculateThreadsPerBar)(3, 5, 3)).toBe(0);
        expect((0, evaluator_1.calculateThreadsPerBar)(3, 5, 4)).toBe(0);
        // Large numbers
        expect((0, evaluator_1.calculateThreadsPerBar)(101, 20, 0)).toBe(6); // 5 with 1 extra
        expect((0, evaluator_1.calculateThreadsPerBar)(101, 20, 19)).toBe(5); // Last bar gets no extra
    });
});
