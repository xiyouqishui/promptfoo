...
describe('matchesLlmRubric', () => {
    ...
    it('should render rubric when provided as an object', async () => {
        ...
        expect(options.provider.callApi).toHaveBeenCalledWith(expect.stringContaining(JSON.stringify(rubric)));
    });
    ...
    it('should throw error when throwOnError is true and provider returns an error', async () => {
        ...
        await expect((0, matchers_1.matchesLlmRubric)(rubric, llmOutput, grading, {}, null, { throwOnError: true })).rejects.toThrow('Provider error');
    });
    it('should throw error when throwOnError is true and provider returns no result', async () => {
        ...
        // With throwOnError: true - should throw
        await expect((0, matchers_1.matchesLlmRubric)(rubric, llmOutput, grading, {}, null, { throwOnError: true })).rejects.toThrow('No output');
    });
    ...
    it('should load rubric prompt from js file when specified', async () => {
        ...
        expect(grading.provider.callApi).toHaveBeenCalledWith(expect.stringContaining('Do this: Test rubric'));
...
describe('matchesContextRelevance', () => {
    ...
    it('should pass when the relevance score is above the threshold', async () => {
        ...
        jest.spyOn(defaults_1.DefaultGradingProvider, 'callApi').mockImplementation(mockCallApi);
        await expect((0, matchers_1.matchesContextRelevance)(input, context, threshold)).resolves.toEqual({
            pass: true,
