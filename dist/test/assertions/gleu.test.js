...
const gleu_1 = require("../../src/assertions/gleu");
describe('GLEU score calculation', () => {
    it('identical sentences should have GLEU score of 1', () => {
        ...
        const score = (0, gleu_1.calculateGleuScore)(candidate, references);
        expect(score).toBe(1);
    });
    ...
    it('should throw error for empty reference array', () => {
        expect(() => {
            (0, gleu_1.calculateGleuScore)('test', []);
    ...
    it('should handle different minN values', () => {
        ...
        const score = (0, gleu_1.calculateGleuScore)(candidate, references, 2);
    ...
    it('should handle different maxN values', () => {
        ...
        const score = (0, gleu_1.calculateGleuScore)(candidate, references, 1, 1);
    ...
    it('should aggregate n-gram matches across different n values', () => {
        ...
        const score = (0, gleu_1.calculateGleuScore)(candidate, references, 1, 2);
    ...
    describe('handleGleuScore', () => {
        it('should handle string reference with passing score', () => {
            ...
            expect((0, gleu_1.handleGleuScore)(params)).toEqual({
                pass: true,
...
//# sourceMappingURL=gleu.test.js.map