    ...
    describe('getTablePage', () => {
        ...
        it('should filter by errors', async () => {
            ...
            for (const row of result.body) {
                const hasError = row.outputs.some((output) => output.text.includes('error') || (output.gradingResult?.reason || '').includes('error'));
        ...
        it('should filter by specific metrics', async () => {
            ...
            for (const row of result.body) {
                const hasMetric = row.outputs.some((output) => output.namedScores && output.namedScores[metricName] !== undefined);
