...
const xai_1 = require("../../src/providers/xai");
...
describe('xAI Provider', () => {
    ...
    describe('Provider creation and configuration', () => {
        it('throws an error if no model name is provided', () => {
            expect(() => (0, xai_1.createXAIProvider)('xai:')).toThrow('Model name is required');
        });
        it('creates an xAI provider with specified model', () => {
            const provider = (0, xai_1.createXAIProvider)('xai:grok-2');
        ...
        it('sets the correct API base URL and API key environment variable', () => {
            (0, xai_1.createXAIProvider)('xai:grok-2');
        ...
        it('merges provided options with xAI-specific config', () => {
            ...
            (0, xai_1.createXAIProvider)('xai:grok-2', options);
    ...
    describe('Provider methods', () => {
        it('generates correct id() for the provider', () => {
            const provider = (0, xai_1.createXAIProvider)('xai:grok-3-beta');
            expect(provider.id()).toBe('xai:grok-3-beta');
        });
        it('returns readable toString() description', () => {
            const provider = (0, xai_1.createXAIProvider)('xai:grok-3-mini-beta');
    ...
    describe('Standard models (grok-3-beta, grok-3-fast-beta)', () => {
        ...
        it('calculates costs correctly for standard models', () => {
            // grok-3-beta pricing
            const betaCost = (0, xai_1.calculateXAICost)('grok-3-beta', {}, 1000, 500);
            expect(betaCost).toBeCloseTo(0.0105);
            // grok-3-fast-beta pricing (more expensive)
            const fastCost = (0, xai_1.calculateXAICost)('grok-3-fast-beta', {}, 1000, 500);
        ...
        it('does not support reasoning effort parameter', () => {
            ...
            (0, xai_1.createXAIProvider)('xai:grok-3-beta', {
                config: {
                    config: {
            ...
            expect(chat_1.OpenAiChatCompletionProvider).toHaveBeenCalledWith('grok-3-beta', expect.objectContaining({
                config: expect.objectContaining({
                    config: {
    ...
    describe('Reasoning models (grok-3-mini-beta, grok-3-mini-fast-beta)', () => {
        ...
        it('supports high reasoning effort parameter', () => {
            (0, xai_1.createXAIProvider)('xai:grok-3-mini-beta', {
                config: {
                    config: {
                        reasoning_effort: 'high',
                    },
        ...
        it('calculates costs correctly for mini models', () => {
            ...
            const miniCost = (0, xai_1.calculateXAICost)('grok-3-mini-beta', {}, 1000, 500);
            expect(miniCost).toBeCloseTo(0.00055);
            // grok-3-mini-fast-beta pricing
            const miniFastCost = (0, xai_1.calculateXAICost)('grok-3-mini-fast-beta', {}, 1000, 500);
        ...
        it('handles multiple configuration options for mini models', () => {
            ...
            (0, xai_1.createXAIProvider)('xai:grok-3-mini-beta', options);
            expect(chat_1.OpenAiChatCompletionProvider).toHaveBeenCalledWith('grok-3-mini-beta', expect.objectContaining({
                config: expect.objectContaining({
    ...
    describe('Legacy models (grok-2)', () => {
        it('calculates costs correctly for grok-2 models', () => {
            ...
            const grok2Cost = (0, xai_1.calculateXAICost)('grok-2-latest', {}, 1000, 500);
            expect(grok2Cost).toBeCloseTo(0.007); // 1000 * (2/1e6) + 500 * (10/1e6)
            // grok-2-vision-latest pricing (same as standard grok-2)
            const grok2VisionCost = (0, xai_1.calculateXAICost)('grok-2-vision-latest', {}, 1000, 500);
    ...
    describe('Cost calculation and token processing', () => {
        it('includes reasoning tokens in cost calculation', () => {
            const cost = (0, xai_1.calculateXAICost)('grok-3-mini-beta', {}, 1000, 500, 200);
            expect(cost).toBeCloseTo(0.00055);
        });
        it('handles model aliases correctly', () => {
            const costWithAlias = (0, xai_1.calculateXAICost)('grok-3-latest', {}, 1000, 500);
            const costWithId = (0, xai_1.calculateXAICost)('grok-3-beta', {}, 1000, 500);
            expect(costWithAlias).toBe(costWithId);
            expect(costWithAlias).toBeCloseTo(0.0105);
        });
        it('returns undefined for unknown models', () => {
            const cost = (0, xai_1.calculateXAICost)('non-existent-model', {}, 1000, 500);
            expect(cost).toBeUndefined();
        });
        it('returns undefined when token counts are missing', () => {
            expect((0, xai_1.calculateXAICost)('grok-3-beta', {}, undefined, 500)).toBeUndefined();
            expect((0, xai_1.calculateXAICost)('grok-3-beta', {}, 1000, undefined)).toBeUndefined();
        });
        it('uses config cost values when provided', () => {
            const customCost = 10.0 / 1e6;
            const cost = (0, xai_1.calculateXAICost)('grok-3-beta', { cost: customCost }, 1000, 500);
        ...
        it('handles different reasoning token counts without changing cost', () => {
            ...
            const cost1 = (0, xai_1.calculateXAICost)('grok-3-mini-beta', {}, 100, 50, 10);
            const cost2 = (0, xai_1.calculateXAICost)('grok-3-mini-beta', {}, 100, 50, 30);
        ...
        it('properly applies custom cost values with reasoning tokens', () => {
            ...
            const cost = (0, xai_1.calculateXAICost)('grok-3-mini-beta', { cost: customCost }, 100, 50, 30);
    ...
    describe('API response handling', () => {
        it('processes reasoning tokens in Grok-3 mini models', () => {
            ...
            const cost = (0, xai_1.calculateXAICost)('grok-3-mini-beta', {}, 100, 50, 30);
        ...
        it('ignores reasoning tokens for non-mini models', () => {
            ...
            const standardCost = (0, xai_1.calculateXAICost)('grok-3-beta', {}, 100, 50);
            const standardWithReasoningCost = (0, xai_1.calculateXAICost)('grok-3-beta', {}, 100, 50, 30);
        ...
        it('applies different pricing models correctly', () => {
            ...
            const miniCost = (0, xai_1.calculateXAICost)('grok-3-mini-beta', {}, 100, 50, 30);
            const betaCost = (0, xai_1.calculateXAICost)('grok-3-beta', {}, 100, 50);
            const grok2Cost = (0, xai_1.calculateXAICost)('grok-2-latest', {}, 100, 50);
