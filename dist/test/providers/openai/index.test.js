...
describe('OpenAI Provider', () => {
    describe('OpenAiGenericProvider', () => {
        const provider = new openai_1.OpenAiGenericProvider('test-model', {
            config: {
                apiKey: 'test-key',
        ...
        it('should use custom API host', () => {
            const customProvider = new openai_1.OpenAiGenericProvider('test-model', {
        ...
        it('should get organization from env', () => {
            ...
            const envProvider = new openai_1.OpenAiGenericProvider('test-model');
