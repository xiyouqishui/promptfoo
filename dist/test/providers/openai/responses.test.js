...
describe('OpenAiResponsesProvider', () => {
    ...
    it('should support various model names', () => {
        ...
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.5-preview');
        expect(responses_1.OpenAiResponsesProvider.OPENAI_RESPONSES_MODEL_NAMES).toContain('gpt-4.5-preview-2025-02-27');
    });
    ...
    it('should handle JSON stringify errors during logging', async () => {
        ...
        expect(cache.fetchWithCache).toHaveBeenCalledWith(expect.stringContaining('/responses'), expect.anything(), expect.anything());
