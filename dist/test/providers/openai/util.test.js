...
describe('failApiCall', () => {
    it('should format OpenAI API errors', () => {
        const error = new openai_1.default.APIError(400, {}, 'Bad request', {});
...
describe('calculateOpenAICost', () => {
    ...
    it('should calculate cost correctly for TTS model gpt-4o-mini-tts', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4o-mini-tts', {}, 1000, 500);
    ...
    it('should calculate cost correctly for gpt-4.5-preview', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.5-preview', {}, 1000, 500);
    ...
    it('should return undefined for zero tokens', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.5-preview', {}, 0, 0);
        expect(cost).toBeUndefined();
    });
    it('should handle only prompt tokens', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.5-preview', {}, 1000, 0);
        expect(cost).toBeCloseTo((1000 * 75) / 1e6, 6);
    });
    it('should handle only completion tokens', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.5-preview', {}, 0, 1000);
        expect(cost).toBeCloseTo((1000 * 150) / 1e6, 6);
    });
    it('should handle large token counts', () => {
        const cost = (0, util_1.calculateOpenAICost)('gpt-4.5-preview', {}, 1000000, 1000000);
