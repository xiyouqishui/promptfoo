...
describe('AIStudioChatProvider', () => {
    ...
    describe('constructor and configuration', () => {
        ...
        it('should handle API host from different sources and render with Nunjucks', () => {
            ...
            // Default host
            const providerWithDefaultHost = new ai_studio_1.AIStudioChatProvider('gemini-pro');
            expect(providerWithDefaultHost.getApiHost()).toBe('rendered-generativelanguage.googleapis.com');
