...
const bedrockKnowledgeBase_1 = require("../../src/providers/bedrockKnowledgeBase");
...
describe('AwsBedrockKnowledgeBaseProvider', () => {
    ...
    it('should throw an error if knowledgeBaseId is not provided', () => {
        expect(() => {
            new bedrockKnowledgeBase_1.AwsBedrockKnowledgeBaseProvider('us.anthropic.claude-3-7-sonnet-20241022-v2:0', {
                config: {},
            });
        }).toThrow('Knowledge Base ID is required');
    });
    it('should create provider with required options', () => {
        const provider = new bedrockKnowledgeBase_1.AwsBedrockKnowledgeBaseProvider('us.anthropic.claude-3-7-sonnet-20241022-v2:0', {
            config: {
        ...
        const expectedCommand = {
            ...
            retrieveAndGenerateConfiguration: {
                ...
                knowledgeBaseConfiguration: {
                    knowledgeBaseId: 'kb-123',
                    modelArn: 'arn:aws:bedrock:us-east-1:aws:foundation-model/us.anthropic.claude-3-7-sonnet-20241022-v2:0',
                },
            },
        };
    ...
    it('should use custom modelArn if provided', async () => {
        ...
        mockSend.mockResolvedValueOnce(mockResponse);
        const provider = new bedrockKnowledgeBase_1.AwsBedrockKnowledgeBaseProvider('amazon.nova-lite-v1:0', {
            config: {
                knowledgeBaseId: 'kb-123',
                region: 'us-east-1',
...
//# sourceMappingURL=bedrockKnowledgeBase.test.js.map