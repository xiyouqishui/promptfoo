...
const echo_1 = require("../../src/providers/echo");
describe('EchoProvider', () => {
    describe('constructor', () => {
        it('should initialize with default options', () => {
            const provider = new echo_1.EchoProvider();
        ...
        it('should initialize with provided options', () => {
            ...
            const provider = new echo_1.EchoProvider(options);
    ...
    describe('callApi', () => {
        ...
        it('should respect the configured delay', async () => {
            const input = 'Test input';
            const provider = new echo_1.EchoProvider({ delay: 100 });
