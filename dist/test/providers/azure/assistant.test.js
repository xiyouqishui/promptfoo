    ...
    describe('function callback implementation', () => {
        it('should load external file-based callbacks', async () => {
            ...
            provider = new assistant_1.AzureAssistantProvider('test-deployment', {
                config: {
                    ...
                    functionToolCallbacks: {
                        testFunction: 'file://path/to/function.js:testFunction',
                    },
                },
            });
            ...
            const mockLoadExternalFunction = jest
                .spyOn(provider, 'loadExternalFunction')
                .mockResolvedValue(jest.fn().mockReturnValue('external function result'));
            // Test the executeFunctionCallback method directly
            const result = await provider.executeFunctionCallback('testFunction', '{"test":"value"}');
            // Verify the result and that loadExternalFunction was called correctly
            expect(mockLoadExternalFunction).toHaveBeenCalledWith('file://path/to/function.js:testFunction');
        ...
        it('should properly cache loaded function callbacks', async () => {
            ...
            await provider.executeFunctionCallback('testFunction', '{"test":"value"}');
            await provider.executeFunctionCallback('testFunction', '{"test":"value2"}');
