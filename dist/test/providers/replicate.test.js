...
const replicate_2 = require("../../src/providers/replicate");
jest.mock('replicate');
jest.mock('../../src/cache');
const MockedReplicate = jest.mocked(replicate_1.default, { shallow: false });
describe('ReplicateProvider', () => {
    ...
    it('should handle successful API calls', async () => {
        ...
        const provider = new replicate_2.ReplicateProvider('test-model', {
...
describe('ReplicateModerationProvider', () => {
    ...
    it('should handle safe content correctly', async () => {
        ...
        MockedReplicate.prototype.run = mockRun;
        const provider = new replicate_2.ReplicateModerationProvider('test-model', {
            config: { apiKey: mockApiKey },
        });
    ...
    it('should handle malformed API responses', async () => {
        ...
        const result = await provider.callModerationApi('test prompt', 'test response');
        expect(result.error).toBe('API response error: Error: API response error: no output: undefined');
    });
    it('should require API key', async () => {
        const provider = new replicate_2.ReplicateModerationProvider('test-model');
        await expect(provider.callModerationApi('test', 'test')).rejects.toThrow('Replicate API key is not set');
    });
...
describe('ReplicateImageProvider', () => {
    ...
    it('should handle successful image generation', async () => {
        ...
        MockedReplicate.prototype.run = mockRun;
        const provider = new replicate_2.ReplicateImageProvider('test-model', {
            config: {
                width: 512,
                height: 512,
            },
...
describe('DefaultModerationProvider', () => {
    it('should be configured with the correct model', () => {
        expect(replicate_2.DefaultModerationProvider.modelName).toBe('meta/llama-guard-3-8b:146d1220d447cdcc639bc17c5f6137416042abee6ae153a2615e6ef5749205c8');
    });
});
